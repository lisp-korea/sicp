...
;; if m1 = m2 and no value . do nothing...
...
"
	...
	env sv => [(connector a) (new-value 10) (informant 'user)]
	sv -> global

	env csv => [(newval 10) (setter 'user)]
	env fee => [(exception 'user) (procedure <proc>) (list '())]
			  {loop}
	csv, fee -> a
